...
const defaultProjects: Project[] = [
  ...
  },
  {
    ...
    category: 'Plumbing',
    categoryKey: 'plumbing',
    image: 'https://images.pexels.com/photos/8292774/pexels-photo-8292774.jpeg?auto=compress&cs=tinysrgb&w=800',
    location: 'Business District',
    year: '2023',
    duration: '12 months',
    features: [
...
export const usePortfolioStore = defineStore('portfolio', () => {
  ...
  // Watch projects and save to localStorage whenever they change
